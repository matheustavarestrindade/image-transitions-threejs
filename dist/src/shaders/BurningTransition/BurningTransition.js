...
var BurningTransition = /** @class */ (function (_super) {
    __extends(BurningTransition, _super);
    function BurningTransition(textures_url) {
        return _super.call(this, textures_url) || this;
    }
    BurningTransition.prototype.onTextureLoaded = function () {
        this.finishLoading({ fragmentShader: loadFragmentShader(this.debugMode) });
    };
    return BurningTransition;
}(ImageTransitionShader));
export default BurningTransition;
//# sourceMappingURL=BurningTransition.js.map