...
var CurlNoisesTransition = /** @class */ (function (_super) {
    __extends(CurlNoisesTransition, _super);
    function CurlNoisesTransition(textures_url) {
        return _super.call(this, textures_url) || this;
    }
    CurlNoisesTransition.prototype.onTextureLoaded = function () {
        this.finishLoading({ fragmentShader: loadFragmentShader(this.debugMode) });
    };
    return CurlNoisesTransition;
}(ImageTransitionShader));
export default CurlNoisesTransition;
//# sourceMappingURL=CurlNoisesTransition.js.map